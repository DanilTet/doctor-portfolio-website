...
const translations = {
  ru: {
    ...
    'hero.badge': 'Эндоскопист, Хирург, УЗИ',
    'hero.name.first': 'Тетерник',
    'hero.name.last': 'Олег Александрович',
    'hero.specialization': 'Врач-эндоскопист, хирург, врач УЗ-диагностики с 8-летним опытом. Специализируюсь на эндоскопии, хирургии, УЗИ и ежегодно выполняю более 3000 эндоскопических исследований!',
    'hero.experience.number': '8',
    'hero.experience.label': 'Лет профессионального\nопыта в медицине',
    'hero.btn.appointment': 'Записаться на прием',
